...
Furthermore, I find [capital](data/concap.csv) longitude, latitude dataset and [suicide](data/sucide.csv) dataset to draw global animation map and conduct relationship analysis.
